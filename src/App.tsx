    ...
    <div className="app">
      ...
      <header className="hero">
        <div className="hero__inner">
          ...
          <h1 className="hero__title">
            MEUS JOGOS <span className="hero__accent">100%</span>
          </h1>
          <p className="hero__sub">
            {games.length} jogos, todas as plataformas, um lugar só.
          </p>
      ...
      <footer className="foot">
        ...
        <p className="foot__dim">
          Dados da Steam em set/2026. Próximo passo: contas de usuário e import automático.
        </p>
      </footer>
    </div>
  )
